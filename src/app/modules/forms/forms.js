...
var defaultAttrs = function (attrs, defaults) {
  ...
  var defClass = (defaults.id === 'hodForm') ? 'hodform' : 'hodform__element'

  if (!attrs['class']) {
    attrs.$set('class', defClass)
  } else {
    attrs.$set('class', attrs.class + ' ' + defClass)
  }
}
  ...
  */
  this.getStandardTextDirective = function (conf) {
    return {
      ...
      transclude: true,
      templateUrl: 'modules/forms/templates/forms-text.html',
  ...
  return {
    ...
    controller: ['$scope', '$element', '$attrs', '$window', '$timeout', function ($scope, $element, $attrs, $window, $timeout) {
      ...
      this.validateForm = function () {
        ...
        var hodformElements = document.getElementsByClassName('hodform__element')
        // console.log(hodformElements, hodformElements.length)
        _.each(hodformElements, function (el, i) {
          var elScope = angular.element(el).isolateScope()
          // console.log(elScope.config)
          // console.log(el)
          // console.log()
...
formsModule.directive('hodRadio', ['FormsService', function (FormsService) {
  return {
    ...
    transclude: true,
    templateUrl: 'modules/forms/templates/forms-radio.html',
    compile: function (element, attrs) {
...
formsModule.directive('hodDate', ['FormsService', function (FormsService) {
  return {
    ...
    transclude: true,
    templateUrl: 'modules/forms/templates/forms-date.html',
    compile: function (element, attrs) {
...
formsModule.directive('hodSortcode', ['FormsService', function (FormsService) {
  return {
    ...
    require: '^^hodForm',
    transclude: true,
    templateUrl: 'modules/forms/templates/forms-sortcode.html',
    scope: {
      field: '=',
      hint: '@hint',
      name: '@name',
...
formsModule.directive('hodSubmit', [function () {
  return {
    ...
    templateUrl: 'modules/forms/templates/forms-submit.html'
  }
}])
